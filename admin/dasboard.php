...
global $conn;
$hasil = mysqli_query ($conn,"SELECT * FROM produk_terjual INNER JOIN master_barang ON produk_terjual.ID_BARANG=master_barang.ID_BARANG WHERE TOTAL >= 2 LIMIT 0,5");
$array = [];
while($data = mysqli_fetch_assoc($hasil)){
  $array[] = $data;
