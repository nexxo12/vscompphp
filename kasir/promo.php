          ...
          <?php
            ...
            <tbody>
              <tr>
                ...
                <td>
                    <a href="edit-promo.php?id=<?=$promo["ID_PROMO"]; ?>" ><button class="btn btn-warning" type="button" name="edit"><i class="fas fa-edit"></i></button></a>
                    <a href="../read/promo.php?view=<?=$promo["ID_PROMO"]; ?>" target="_blank"><button class="btn btn-primary" type="button" name="view"><i class="fas fa-eye"></i></button></a>
