    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="prosessor.php">Prosessor</a>
          <a class="dropdown-item" href="motherboard.php">Motherboard</a>
          <a class="dropdown-item" href="memory.php">Memory</a>
          <a class="dropdown-item" href="power-supply.php">Power Supply</a>
          <a class="dropdown-item" href="casing.php">Casing</a>
          <a class="dropdown-item" href="ssd-hdd.php">SSD & HDD</a>
        </div>
      </li>
      <li class="nav-item">
